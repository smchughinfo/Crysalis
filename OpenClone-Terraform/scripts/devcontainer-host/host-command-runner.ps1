...
$scriptPath = Join-Path $env:OpenClone_Root_Dir 'openclone-terraform\scripts\devcontainer-host\script-to-run.bat'
$directoryPath = Join-Path $env:OpenClone_Root_Dir 'openclone-terraform\scripts\devcontainer-host'
