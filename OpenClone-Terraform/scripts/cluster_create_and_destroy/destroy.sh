...
destroy() {
  ...
  run_terraform_destroy # i think this step is actually not necessary as everything it does gets covered by destroying the cluster and the workspace. but here it is anyways, just in case... oh, and if it fails oh well, just continue executing the rest of the destroy script.
