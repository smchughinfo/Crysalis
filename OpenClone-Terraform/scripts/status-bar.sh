...
set_statusbar_text() {
    local settings_file="/workspaces/OpenClone-Terraform/.vscode/settings.json"
    local new_text="$1"
...
install_statusbar() {
    ...
    local extension_filepath="/workspaces/OpenClone-Terraform/openclone-devcontainer-statusbar.vsix"
