...
def delete_migrations_directories():
    delete_dir(os.path.join(openclone_root_dir, "OpenClone/OpenClone.Services/Migrations"))
    delete_dir(os.path.join(openclone_root_dir, "OpenClone/OpenClone.Core/Migrations"))
...
def migrate(openclone_db_connnection_string, log_db_connnection_string, database_reset=True):
    ...
    # Using the context manager to temporarily set environment variables
    with temporary_env_vars(new_env_vars):
        ...
        run_powershell_commands(f"""
            ...
            {get_migration_commands("OpenClone/openclone.UI/openclone.UI.csproj", "OpenClone/openclone.core/openclone.core.csproj", "LogDbContext")}
            {get_migration_commands("OpenClone/openclone.UI/openclone.UI.csproj", "OpenClone/openclone.Services/openclone.Services.csproj", "ApplicationDbContext")}
        """)
