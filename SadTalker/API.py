...
def generate_deepfake():
    result = handleRequest(request, generateDeepfake)
    
    # Log the exit event (optional)
    GlobalVariables.applicationLog.log("Exiting application after handling /generate-deepfake request.")
