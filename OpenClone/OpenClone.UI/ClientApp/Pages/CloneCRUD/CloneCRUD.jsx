                                ...
                                <div className="mb-3">
                                    <div className="row g-2">
                                        <div className="col-md-6">
                                            ...
                                            <div className="mb-3">
                                                <div className="img-thumbnail" style={{ width: '100%', height: '200px', backgroundColor: 'gray' }}>
                                                    <img src={cloneImage} alt="Profile placeholder"></img>
                                                </div>
                                            </div>
                                            <input
                                                id="cloneImageInput"
                                                ...
                                                required={ activeClone == null ? 'required' : undefined }
                                            />
